...
export default function (props) {
  ...
  let theItem = eCommereData.data.find((obj) => obj.id == props.item);

  let [cartItem, setcartItem] = useState(
    eCommereData.data.find((obj) => obj.id == props.item)
  );
  ...
  function handleClick() {
    ...
    const deleteThis = oldArr.indexOf(
      oldArr.find((obj) => obj.itemId == props.item)
